    ...
    <div className="office-page">
      ...
      <div className="office-header">
        <div className="office-header-content">
          <h1 className="office-header-title"><Plus className="inline-icon" size={28} /> Add Early Access Item</h1>
        </div>
      </div>
      ...
      <div className="office-content">
        <div className="ea-form-container">
          <div className="ea-form-card">
            ...
            <p className="ea-form-desc">Fill in the information for the Early Access listing</p>
            ...
            <form onSubmit={handleSubmit} className="ea-form">
              ...
              <div className="ea-form-actions">
                ...
                <button type="submit" className="btn-primary" disabled={loading}>{loading ? 'Saving...' : 'Add Item'}</button>
              </div>
            </form>
          </div>
        </div>
