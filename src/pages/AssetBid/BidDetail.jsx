...
const bidData = [
  { id: 1, title: 'Commercial Building South Jakarta', type: 'Commercial Property', opening: 'IDR 15,000,000,000', estimate: 'IDR 18,000,000,000', deadline: '2026-05-30', status: 'Active', location: 'South Jakarta', description: 'A prime commercial building in the heart of South Jakarta with excellent visibility and foot traffic. Fully renovated with modern amenities.', image: 'https://images.unsplash.com/photo-1486325212027-8081e485255e?w=600&h=400&fit=crop' },
  { id: 2, title: 'Bekasi Industrial Estate', type: 'Industrial Land', opening: 'IDR 8,500,000,000', estimate: 'IDR 11,000,000,000', deadline: '2026-06-15', status: 'Active', location: 'Bekasi', description: 'Strategic industrial land in Bekasi with easy access to major highways and logistics facilities.', image: 'https://images.unsplash.com/photo-1513828583688-c52646db42da?w=600&h=400&fit=crop' },
  { id: 3, title: 'Premium Shophouse BSD City', type: 'Retail Property', opening: 'IDR 3,200,000,000', estimate: 'IDR 4,000,000,000', deadline: '2026-06-20', status: 'Active', location: 'Tangerang', description: 'A premium shophouse in the busy BSD City commercial area, perfect for retail or F&B business.', image: 'https://images.unsplash.com/photo-1570129477492-45a003537e1f?w=600&h=400&fit=crop' },
]
      ...
      <div className="container">
        <div className="bid-detail__wrapper">
          ...
          <div className="bid-detail__main">
            <div className="bid-detail__image">
              <img src={bid.image} alt={bid.title} className="bid-detail__img" onError={(e) => { e.target.style.display = 'none' }} />
            </div>
              ...
              <div className="bid-detail__info-grid">
                <div className="bid-detail__info-item">
                  ...
                  <div>
                    ...
                    <span className="bid-detail__info-value">{bid.location}</span>
                  </div>
                </div>
                <div className="bid-detail__info-item">
