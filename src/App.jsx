...
import KasirinPrivacyPolicy from "./pages/kasirin/PrivacyPolicy";
import "./App.css";
    ...
    <>
      ...
      <main>
        <Routes>
          ...
          <Route
            path="/early-access/detail/:id"
            element={<EarlyAccessDetail />}
          />
          ...
          <Route
            path="/kasirin/privacy-policy"
            element={<KasirinPrivacyPolicy />}
          />
          ...
          />
          <Route
            path="/office/early-access/create"
            element={
              <OfficeLayout>
                <CreateEarlyAccess />
              </OfficeLayout>
          ...
          />
          <Route
            path="/office/early-access/edit/:id"
            element={
              <OfficeLayout>
                <EditEarlyAccess />
              </OfficeLayout>
